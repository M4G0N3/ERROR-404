    ...
    <main>
       <div className="pattern" />
        ...
        <div className="wrapper">
            <h3 className="titleName">
                Find <span className="text-gradient">Movies</span>  around the
                world
            </h3>
        </div>
      ...
      <header>
        ...
        <section className="all-movies">
            ...
            <h2 className="mt-0 mb-15">{debouncedSearchTerm ? `Showing results for ${debouncedSearchTerm}` : "All Movies"}</h2>
